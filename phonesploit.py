...
page_1 = '''\n
{0}[{1}1{0}] {2}显示已连接的设备       {0}[{1}6{0}] {2}录音                    {0}[{1}11{0}] {2}卸载APP                   
{0}[{1}2{0}] {2}断开所有设备           {0}[{1}7{0}] {2}截屏                    {0}[{1}12{0}] {2}显示设备的实时日志       
{0}[{1}3{0}] {2}连接一个新的设备       {0}[{1}8{0}] {2}重启连接服务            {0}[{1}13{0}] {2}显示系统信息
{0}[{1}4{0}] {2}shell这个设备          {0}[{1}9{0}] {2}从设备向本机传送数据    {0}[{1}14{0}] {2}列出设备所有APP           
{0}[{1}5{0}] {2}向该设备安装一个apk    {0}[{1}10{0}] {2}关机                   {0}[{1}15{0}] {2}运行APP                         


{0}[{1}99{0}] {2}退出   {0}[{1}0{0}] {2}清除   {0}[{1}p{0}] 下一页                           
'''.format(Fore.CYAN, Fore.RED, Fore.GREEN)

page_2 = '''\n
{0}[{1}16{0}]{2} 转发端口               {0}[{1}21{0}]{2} 网络统计               {0}[{1}26{0}]{2} 从设备向本机传送数据
{0}[{1}17{0}]{2} Grab wpa_supplicant    {0}[{1}22{0}]{2} 开/关WIFI              {0}[{1}27{0}]{2} 修改设备分辨率
{0}[{1}18{0}]{2} 显示Mac/Inet           {0}[{1}23{0}]{2} 删除密码               {0}[{1}28{0}]{2} 恢复设备分辨率
{0}[{1}19{0}]{2} 从应用程序中提取apk    {0}[{1}24{0}]{2} 使用虚拟键             {0}[{1}29{0}]{2} 赋予APP权限
{0}[{1}20{0}]{2} 获取电池状态           {0}[{1}25{0}]{2} 获取当前活动           {0}[{1}30{0}]{2} 执行adb命令


{0}[{1}99{0}] {2}退出   {0}[{1}0{0}] {2}清除   {0}[{1}b{0}] 返回第一页
'''.format(Fore.CYAN, Fore.RED, Fore.GREEN)
...
def main():
    ...
    if option == '1':
        ...
        print (("\n[{0}+{1}] 输入IP地址").format(Fore.RED, Fore.WHITE))
        ip = input(arrow+" phonesploit"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
        os.system("adb connect "+ip+":5555")
    
    elif option  == '4':
        print (("\n[{0}+{1}]输入该设备名").format(Fore.RED, Fore.WHITE))
        ...
        print (("     "+connect))
        print (("    [{0}+{1}]输入你想保存图片的位置").format(Fore.RED, Fore.WHITE))
        ...
        print (("     "+connect))
        print (("    [{0}+{1}]输入设备上的文件位置").format(Fore.RED, Fore.WHITE))
        file_location = input("    "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("        "+connect))
        print (("       [{0}+{1}]输入你想保存该文件的目录").format(Fore.RED, Fore.WHITE))
        ...
        print (("     "+connect))
        print (("    [{0}+{1}]输入包名").format(Fore.RED, Fore.WHITE))
        ...
        print (("     "+connect))
        print (("    [{0}+{1}]输入包名，例：com.snapchat.android").format(Fore.RED, Fore.WHITE))
        ...
        print (("     "+connect))
        print (("    [{0}+{1}]输入设备上的端口").format(Fore.RED, Fore.WHITE))
        port_device = input("    "+arrow + "phonesploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("         "+connect))
        print (("        [{0}+{1}]输入端口并将其转发").format(Fore.RED, Fore.WHITE))
        ...
        try:
            print (("[{0}+{1}]输入该设备名").format(Fore.RED, Fore.WHITE))
...
def main_linux():
    ...
    os.system("adb tcpip 5555")
    os.system("adb devices -l")
    print (("\n[{0}+{1}] 输入IP地址(输入99退出)").format(Fore.RED, Fore.WHITE))
    try:
    ...
    while(1):
        if option == '1':
            ...
            print (("     "+connect))
            os.system("adb -s "+device_name+" shell screenrecord /sdcard/demo.mp4")
            print (("    [{0}+{1}]请输入你想保存该视频的目录[默认：当前phonesploit目录]").format(Fore.RED, Fore.WHITE))
            place_location = input("    "+arrow + "phonesploit"+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" pull /sdcard/demo.mp4 "+place_location)
            option = input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
            ...
            os.system("adb -s "+device_name+" shell screencap /sdcard/screen.png")
            print (("     "+connect))
            print (("    [{0}+{1}]请输入你想保存该截屏的目录[默认：当前phonesploit目录]").format(Fore.RED, Fore.WHITE))
            place_location = input("    "+arrow + "phonesploit"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" pull /sdcard/screen.png "+place_location)
            option = input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
            ...
            file_location = input("    "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            print (("        "+connect))
            print (("       [{0}+{1}]请输入你想保存该文件的当前目录[默认：当前phonesploit目录]").format(Fore.RED, Fore.WHITE))
            place_location = input("       "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" pull "+file_location+" "+place_location)
            option = input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]请输入包名").format(Fore.RED, Fore.WHITE))
            package_name = input("    "+arrow + "phonesploit"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" unistall "+package_name)
            option = input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]请输入包名，例：com.snapchat.android").format(Fore.RED, Fore.WHITE))
            package_name = input("    "+arrow + "phonesploit"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" shell monkey -p "+package_name+" -v 500")
            option = input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]请输入该设备的端口").format(Fore.RED, Fore.WHITE))
            port_device = input("    "+arrow + "phonesploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
            print (("         "+connect))
            print (("        [{0}+{1}]输入端口并将其转发").format(Fore.RED, Fore.WHITE))
            forward_port = input("        "+arrow + "phonesploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
    ...
    85 -->  "TAG_LAST_KEYCODE"
            ...
            device_name = input(arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            print (("     "+connect))
            print (("    [{0}+{1}]输入想保存到该设备上的目录").format(Fore.RED, Fore.WHITE))
            file_location = input("    "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            print (("        "+connect))
            print (("       [{0}+{1}]输入想传送的文件目录").format(Fore.RED, Fore.WHITE))
            place_location = input("       "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" push "+place_location+" "+file_location)         
            
        elif option == '27':
            print (("[{0}+{1}]请输入分辨率[例：1136x2480]").format(Fore.RED, Fore.WHITE))
            vm = input(arrow + "phonesploit"+Fore.RED + "(vm) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+"shell wm size "+vm)
            
        elif option == '28':
            os.system("adb -s "+device_name+"shell wm size reset")
            print (("[{0}+{1}]设备已恢复默认分辨率").format(Fore.RED, Fore.WHITE))
        
        elif option == '29':
            print (("[{0}+{1}]输入APP权限[例：android.permission.READ_LOGS]").format(Fore.RED, Fore.WHITE))
            app_qx = input(arrow + "phonesploit"+Fore.RED + "(app权限) "+Fore.WHITE + "> ")
            print (("     "+connect))
            print (("    [{0}+{1}]输入APP包名[例：com.snapchat.android]").format(Fore.RED, Fore.WHITE))
            bagname = input("    "+arrow + "phonesploit"+Fore.RED + "(app权限) "+Fore.WHITE + "> ")
            print (("        "+connect))
            print (("       [{0}+{1}]输入想传送的文件目录").format(Fore.RED, Fore.WHITE))
            place_location = input("       "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" shell pm grant "+bagname+" "+app_qx)         
        
        elif option == '30':
            print (("[{0}+{1}]输入adb命令[例：pull a b]").format(Fore.RED, Fore.WHITE))
            command = input(arrow + "phonesploit"+Fore.RED + "(adb) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" "+command)
